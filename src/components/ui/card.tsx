...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-col space-y-1.5 p-4", className)} // Changed p-6 to p-4
    {...props}
  />
))
...
const CardTitle = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>  // Corrected from HTMLHeadingElement to HTMLDivElement based on usage
>(({ className, ...props }, ref) => ( // Corrected from h3 to div to match usage
...
>(({ className, ...props }, ref) => ( // Corrected from p to div
